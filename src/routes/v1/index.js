...
const userFindByUsername = require('./users/findByUsername');
...
const lobbyLeaveTutorial = require('./lobby/leaveTutorial');
...
router.use('/users/findByUsername', userFindByUsername);
...
router.use('/lobby/leaveTutorial', lobbyLeaveTutorial);
